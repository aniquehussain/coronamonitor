  ...
  request(options, function(error, response, body) {
    ...
    for (var i = 0; i < jsonData.response.length; i++) {
      if (jsonData.response[i].country == countryName) {
        ...
        res.write("<body style='border-width:0px;'><br><br><h1 style='text-align: center;color:#F20152;font-family: sans-serif;font-weight:500'> STATISTICS </h1><br><br><br><br></body>");
